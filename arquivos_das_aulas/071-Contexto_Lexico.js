//CONTEXTO LÉXICO:
//Contexto léxico é como chamamos o local onde um elemento é escrito, ou seja, o contexto pelo qual um objeto foi gerado e nasceu.
//O contexto léxico é um conceito muito utilizado em Funções, visto que as funções possuem closures (memória de contexto léxico), o que faz com que elas sempre referenciem a variáveis e outros elementos que são visíveis ao seu contexto léxico, enquando elementos que estão encapsulados dentro de outros contextos léxicos não são visíveis para as funções.
...
//FUNÇÃO REFERENCIANDO SEU VERDADEIRO CONTEXTO LÉXICO:
...
//FUNÇÃO REFERENCIANDO VARIÁVEL Á PARTIR DE UM ESCOPO DE FUNÇÃO, POIS, FOI CRIADA DENTRO DESTE ESCOPO:
